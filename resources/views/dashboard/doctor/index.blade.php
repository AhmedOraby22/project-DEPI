...
@section('content')
    ...
    <div class="container">
        ...
        <div class="card-header row">
            <div class="card-title col-6">List of Doctors</div>
            ...
            <table class="table table-striped table-hover table-primary table-bordered">
                ...
                @foreach($datas as $data)
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('dashboard.doctor.edit', $data->id) }}"
                               class="btn btn-warning btn-sm">Update</a>

                            <a href="{{ route('dashboard.doctor.show', $data->id) }}"
                               class="btn btn-warning btn-sm">Show</a>
                            <br>
                            <br>

                            <form action="{{ route('dashboard.doctor.destroy', $data->id) }}" method="post"
